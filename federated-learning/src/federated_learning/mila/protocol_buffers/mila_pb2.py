...
_CHECKPOINT = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="token",
            full_name="mila.Checkpoint.token",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="content",
            full_name="mila.Checkpoint.content",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
...
_MODEL = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            ...
            full_name="mila.Model.json_configuration",
            index=0,
            number=1,
            type=12,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            ...
            full_name="mila.Model.latest_checkpoint",
            index=1,
            number=2,
            type=12,
            cpp_type=9,
