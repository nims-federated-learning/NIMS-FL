...
from vendor.captum._utils.models.model import Model
...
class SGDLinearModel(LinearModel):
    def __init__(self, **kwargs) -> None:
        ...
        """
        # avoid cycles
        from vendor.captum._utils.models.linear_model.train import (
...
class SGDLasso(SGDLinearModel):
    ...
    def fit(self, train_data: DataLoader, **kwargs):
        # avoid cycles
        from vendor.captum._utils.models.linear_model.train import l2_loss
