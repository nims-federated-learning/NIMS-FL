...
from vendor.captum._utils.common import (
...
from vendor.captum._utils.gradient import compute_layer_gradients_and_eval
from vendor.captum._utils.typing import (
    BaselineType,
    TargetType,
    TensorOrTupleOfTensorsGeneric,
)
from vendor.captum.attr._utils.approximation_methods import approximation_parameters
from vendor.captum.attr._utils.attribution import GradientAttribution, NeuronAttribution
from vendor.captum.attr._utils.batching import _batch_attribution
from vendor.captum.attr._utils.common import (
    _format_input_baseline,
    _reshape_and_sum,
    _validate_input,
    neuron_index_deprecation_decorator,
)
from vendor.captum.log import log_usage
