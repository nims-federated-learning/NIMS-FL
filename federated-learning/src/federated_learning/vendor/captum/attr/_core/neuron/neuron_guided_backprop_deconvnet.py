...
from vendor.captum._utils.gradient import construct_neuron_grad_fn
from vendor.captum._utils.typing import TensorOrTupleOfTensorsGeneric
from vendor.captum.attr._core.guided_backprop_deconvnet import (
    Deconvolution,
    GuidedBackprop,
)
from vendor.captum.attr._utils.attribution import GradientAttribution, NeuronAttribution
from vendor.captum.attr._utils.common import neuron_index_deprecation_decorator
