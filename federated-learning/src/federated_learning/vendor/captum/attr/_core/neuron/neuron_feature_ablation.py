...
from vendor.captum._utils.common import _verify_select_neuron
from vendor.captum._utils.gradient import _forward_layer_eval
from vendor.captum._utils.typing import BaselineType, TensorOrTupleOfTensorsGeneric
from vendor.captum.attr._core.feature_ablation import FeatureAblation
from vendor.captum.attr._utils.attribution import (
    NeuronAttribution,
