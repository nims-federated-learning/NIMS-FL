...
class Summarizer:
    ...
    >>>from vendor.captum.attr.aggregator import Summarizer
    >>>from vendor.captum.attr._utils.stats import Mean, StdDev
    >>>
    ...
    def update(self, x: Union[Tensor, Tuple[Tensor, ...]]):
        ...
        from vendor.captum._utils.common import _format_tensor_into_tuples
